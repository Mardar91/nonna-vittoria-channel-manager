...
import { useState, useEffect, useCallback } from 'react'; // Aggiunto useCallback qui
...
export default function CheckInPage() {
  ...
  }, [router]); // Dipendenze per useCallback

  useEffect(() => {
    loadProfile();
  }, [loadProfile]); // Chiamata a loadProfile con la sua dipendenza
